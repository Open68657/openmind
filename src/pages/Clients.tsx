      ...
      <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {clients.map((client) => (
            ...
            >
              {/* Gradient top bar */}
              <div className="h-1.5 bg-gradient-to-l from-brand-pink to-brand-purple opacity-60 group-hover:opacity-100 transition-opacity duration-300" />
              <CardContent className="p-7">
                <div className="flex items-center gap-3 mb-5">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-pink/10 to-brand-purple/10">
                ...
                <Button
                  variant="outline"
                  className="w-full rounded-xl group-hover:bg-gradient-to-l group-hover:from-brand-pink group-hover:to-brand-purple group-hover:text-white group-hover:border-transparent transition-all duration-300"
